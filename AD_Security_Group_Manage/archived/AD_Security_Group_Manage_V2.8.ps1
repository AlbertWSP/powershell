# 2026-03-19
# @Albert Ng
# AD Security Group Manager - Version 2.8
...
# [功能模組] 安全地將 DataTable 匯出為 Excel (使用 COM 介面，確保資源正確釋放)
function Export-DataTableToExcel {
    ...
    try {
        ...
        # 儲存 Excel (51 = xlOpenXMLWorkbook .xlsx)
...
$form.Text = "AD Security Group Manager - Version 2.8"
