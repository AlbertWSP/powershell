# 2026-03-18
# @Albert Ng
# AD Security Group Manager - Version 2.7
...
$btnCheckAcl.Location = "20, 70"
$btnCheckAcl.Size = "150, 35"
$btnCheckAcl.Text = "Check Permissions"
$btnCheckAcl.BackColor = "LightGreen"
$tabACL.Controls.Add($btnCheckAcl)

# BEGIN CHANGE - Add Export Excel/CSV button to ACL Viewer
...
$btnExportAclCsv.Location = "340, 70"
...
$dgvAcl.Location = "20, 120"
$dgvAcl.Size = "785, 360"
$dgvAcl.Anchor = "Top, Bottom, Left, Right"
$dgvAcl.ReadOnly = $true
#$dgvAcl.AutoSizeColumnsMode = "AllCells"
$dgvAcl.BackgroundColor = "White"
$dgvAcl.RowHeadersVisible = $false
...
$lblAclOwner.Location = "20, 500"
$lblAclOwner.Size = "800, 25"
$lblAclOwner.ForeColor = "DarkBlue"
$lblAclOwner.Anchor = "Bottom, Left"
$tabACL.Controls.Add($lblAclOwner)

# ACL Viewer state
$script:currentAclData = $null
$script:currentAclPath = $null
$script:currentAclOwner = $null
...
$btnCheckAcl.Add_Click({
        ...
        try {
            ...
            $null = $dt.Columns.Add("IdentityReference")
            $null = $dt.Columns.Add("FileSystemRights")
            $null = $dt.Columns.Add("AccessControlType")
            ...
            # BEGIN CHANGE - Enable export after ACL load
            ...
            # BEGIN CHANGE - Reset export state on failure
            $btnExportAclExcel.Enabled = $false
            $btnExportAclCsv.Enabled = $false
            $script:currentAclData = $null
            $script:currentAclPath = $null
...
# BEGIN CHANGE - ACL Viewer Export CSV event (button existed but handler missing)
$btnExportAclCsv.Add_Click({
        ...
        if ($saveFile.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
            ...
            try {
                # Convert DataTable -> objects
                $out = foreach ($r in $script:currentAclData.Rows) {
                    [pscustomobject]@{
                ...
                $out | Export-Csv -Path $saveFile.FileName -NoTypeInformation -Encoding UTF8 -Force
                ...
                [System.Windows.Forms.MessageBox]::Show(
                    "CSV export failed.`n`n$($_.Exception.Message)",
                    "Export Error",
                    "OK",
                    "Error"
                )
...
$panelHint4.Location = "20, 10"
$panelHint4.Size = "790, 110"
$panelHint4.BackColor = "Info"
$panelHint4.Anchor = "Top, Left, Right"
$tabAccessChk.Controls.Add($panelHint4)

$lblHint4 = New-Object System.Windows.Forms.Label
$lblHint4.Text = @"
FUNCTION: Check Individual Access Rights.

GUIDELINES:
1. Enter or Browse to a folder path.
2. Enter the user's Email or SAM account name.
3. Click 'Check Access' to see their effective permissions (direct + via group memberships).
"@
$lblHint4.Dock = "Fill"
$lblHint4.Padding = "10, 10, 10, 10"
$lblHint4.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold)
$panelHint4.Controls.Add($lblHint4)

$lblAccessPath = New-Object System.Windows.Forms.Label
$lblAccessPath.Location = "20, 130"
$lblAccessPath.Size = "100, 20"
$lblAccessPath.Text = "Folder Path:"
$tabAccessChk.Controls.Add($lblAccessPath)

$txtAccessPath = New-Object System.Windows.Forms.TextBox
$txtAccessPath.Location = "20, 155"
$txtAccessPath.Size = "790, 25"
$txtAccessPath.Anchor = "Top, Left"
$txtAccessPath.Add_KeyDown({
        param($s, $e)
        if ($e.Control -and $e.KeyCode -eq [System.Windows.Forms.Keys]::A) {
            $s.SelectAll()
            $e.SuppressKeyPress = $true
...
$lblAccessUser.Location = "20, 195"
$lblAccessUser.Size = "150, 20"
$lblAccessUser.Text = "User (Email or SAM):"
$tabAccessChk.Controls.Add($lblAccessUser)

$txtAccessUser = New-Object System.Windows.Forms.TextBox
$txtAccessUser.Location = "20, 220"
$txtAccessUser.Size = "400, 25"
$txtAccessUser.Add_KeyDown({
        param($s, $e)
        if ($e.Control -and $e.KeyCode -eq [System.Windows.Forms.Keys]::A) {
            $s.SelectAll()
            $e.SuppressKeyPress = $true
...
$btnCheckAccess.Location = "430, 218"
$btnCheckAccess.Size = "150, 30"
$btnCheckAccess.Text = "Check Access"
$btnCheckAccess.BackColor = "LightGreen"
$tabAccessChk.Controls.Add($btnCheckAccess)

$btnClearTab4 = New-Object System.Windows.Forms.Button
$btnClearTab4.Location = "590, 218"
$btnClearTab4.Size = "100, 30"
$btnClearTab4.Text = "Clear"
$tabAccessChk.Controls.Add($btnClearTab4)

$lblAccessInfo = New-Object System.Windows.Forms.Label
$lblAccessInfo.Location = "20, 260"
$lblAccessInfo.Size = "790, 20"
$lblAccessInfo.ForeColor = "DarkBlue"
$lblAccessInfo.AutoSize = $false
$lblAccessInfo.Anchor = "Top, Left, Right"
$tabAccessChk.Controls.Add($lblAccessInfo)

$lblMatchedGroups = New-Object System.Windows.Forms.Label
$lblMatchedGroups.Location = "20, 285"
$lblMatchedGroups.Size = "400, 18"
$lblMatchedGroups.Text = "Matched Groups (ACL Group → User Membership Path):"
...
$dgvMatchedGroups.Location = "20, 305"
$dgvMatchedGroups.Size = "785, 130"
$dgvMatchedGroups.BackColor = "White"
$dgvMatchedGroups.Anchor = "Top, Left, Right"
$dgvMatchedGroups.ReadOnly = $true
$dgvMatchedGroups.AutoSizeColumnsMode = "Fill"
$dgvMatchedGroups.SelectionMode = "FullRowSelect"
$dgvMatchedGroups.AllowUserToAddRows = $false
$dgvMatchedGroups.RowHeadersVisible = $false
$tabAccessChk.Controls.Add($dgvMatchedGroups)

$lblPermHeader = New-Object System.Windows.Forms.Label
$lblPermHeader.Location = "20, 440"
$lblPermHeader.Size = "300, 18"
$lblPermHeader.Text = "Effective Permissions:"
...
$dgvAccess.Location = "20, 460"
$dgvAccess.Size = "785, 375"
$dgvAccess.Anchor = "Top, Bottom, Left, Right"
$dgvAccess.ReadOnly = $true
#$dgvAccess.AutoSizeColumnsMode = "Fill"
$dgvAccess.BackgroundColor = "White"
$dgvAccess.SelectionMode = "FullRowSelect"
$dgvAccess.AllowUserToAddRows = $false
$dgvAccess.RowHeadersVisible = $false
...
$panelHint1.Location = "20, 10"
$panelHint1.Size = "790, 130"
$panelHint1.BackColor = "Info"
$panelHint1.Anchor = "Top, Left, Right"
$tabView.Controls.Add($panelHint1)

$lblHint1 = New-Object System.Windows.Forms.Label
$lblHint1.Text = @"
FUNCTION: Review Group Membership.

GUIDELINES:
1. Enter Group Name or Email and click 'Fetch'.
2. Use 'Export CSV' to save the current list.
3. QUICK ACTION: Select row(s), RIGHT-CLICK, and choose 'Add selected to Modify list' to transfer users to the next tab.
"@
$lblHint1.Dock = "Fill"
$lblHint1.Padding = "10, 10, 10, 10"
$lblHint1.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold)
...
$txtGroupSearch.AutoSize = $false   # ✅ FIX: prevent WinForms overriding width on layout
...
$lblCount.Location = "20, 200"
$lblCount.ForeColor = "Blue"
$lblCount.AutoSize = $false
$tabView.Controls.Add($lblCount)

$lblSubGroups = New-Object System.Windows.Forms.Label
$lblSubGroups.Location = "20, 225"
$lblSubGroups.Size = "400, 18"
$lblSubGroups.Text = "Sub-Groups (nested groups inside this group):"
...
$dgvSubGroups.Location = "20, 245"
$dgvSubGroups.Size = "785, 130"
$dgvSubGroups.Anchor = "Top, Left, Right"
$dgvSubGroups.ReadOnly = $true
$dgvSubGroups.AutoSizeColumnsMode = "Fill"
$dgvSubGroups.BackgroundColor = "White"
$dgvSubGroups.SelectionMode = "FullRowSelect"
$dgvSubGroups.AllowUserToAddRows = $false
$dgvSubGroups.RowHeadersVisible = $false
$tabView.Controls.Add($dgvSubGroups)

$lblMembersHeader = New-Object System.Windows.Forms.Label
$lblMembersHeader.Location = "20, 380"
$lblMembersHeader.Size = "300, 18"
$lblMembersHeader.Text = "All Members (recursive):"
...
$dgvMembers.Location = "20, 400"
$dgvMembers.Size = "785, 445"
$dgvMembers.Anchor = "Top, Bottom, Left, Right"
$dgvMembers.ReadOnly = $true
$dgvMembers.AutoSizeColumnsMode = "Fill"
...
$tabControl.TabPages.Add($tabAccessChk) # Access Checker moved to last tab

$panelHint2 = New-Object System.Windows.Forms.Panel
$panelHint2.Location = "20, 10"
$panelHint2.Size = "790, 150"
$panelHint2.BackColor = "Info"
$panelHint2.Anchor = "Top, Left, Right"
$tabUpdate.Controls.Add($panelHint2)

$lblHint2 = New-Object System.Windows.Forms.Label
$lblHint2.Text = @"
FUNCTION: Bulk Membership Management.

GUIDELINES:
1. Enter the 'Target Security Group'.
2. Populate identifiers (Email/SAM) via Import or Right-Click from the Audit tab.
3. Select 'Bulk ADD' or 'Bulk REMOVE'.
4. A log file will be generated for all transactions.
"@
$lblHint2.Dock = "Fill"
$lblHint2.Padding = "10, 10, 10, 10"
$lblHint2.Font = New-Object System.Drawing.Font("Segoe UI", 9, [System.Drawing.FontStyle]::Bold)
...
$txtTargetGroup.AutoSize = $false   # ✅ FIX: prevent WinForms overriding width on layout
$txtTargetGroup.Add_KeyDown({
        param($s, $e)
        if ($e.Control -and $e.KeyCode -eq [System.Windows.Forms.Keys]::A) {
            $s.SelectAll()
            $e.SuppressKeyPress = $true
...
$dgvInput.Location = "20, 230"
$dgvInput.Size = "785, 220"
$dgvInput.Anchor = "Top, Bottom, Left, Right"

$col1 = New-Object System.Windows.Forms.DataGridViewTextBoxColumn
$col1.HeaderText = "User Identifier (Email or SAM)"
$col1.Name = "colIdentifier"
$col1.Width = 700
$null = $dgvInput.Columns.Add($col1)

$tabUpdate.Controls.Add($dgvInput)

$btnAdd = New-Object System.Windows.Forms.Button
$btnAdd.Text = "Bulk ADD"
$btnAdd.Location = "20, 465"
$btnAdd.Width = 120
...
$btnRemove.Text = "Bulk REMOVE"
$btnRemove.Location = "150, 465"
$btnRemove.Width = 120
$btnRemove.BackColor = "LightCoral"
$btnRemove.Anchor = "Bottom, Left"
$tabUpdate.Controls.Add($btnRemove)

$btnClearTab2 = New-Object System.Windows.Forms.Button
$btnClearTab2.Text = "Clear List"
$btnClearTab2.Location = "685, 465"
$btnClearTab2.Width = 120
$btnClearTab2.Anchor = "Bottom, Right"
$tabUpdate.Controls.Add($btnClearTab2)

$txtUpdateLog = New-Object System.Windows.Forms.TextBox
$txtUpdateLog.Location = "20, 500"
$txtUpdateLog.Size = "785, 330"
$txtUpdateLog.Multiline = $true
$txtUpdateLog.ReadOnly = $true
$txtUpdateLog.ScrollBars = "Vertical"
$txtUpdateLog.Anchor = "Bottom, Left, Right"
...
# Context Menu (Audit -> Bulk Updates transfer)
...
# Tab "Audit Members" Fetch (v2.0: validation, nested groups, DataTable binding, wait cursor)
...
$btnFetch.Add_Click({
        ...
        try {
            ...
            $null = $dtSubGroups.Columns.Add("Sub-Group Name")
            $null = $dtSubGroups.Columns.Add("Members (recursive)")

            foreach ($sg in $subGroupObjects) {
                $sgMemberCount = (
                    Get-ADGroupMember -Identity $sg -Recursive -ErrorAction SilentlyContinue |
                ...
                $null = $dtSubGroups.Rows.Add($sgRow)
            }
            ...
            $dt = New-Object System.Data.DataTable
            $null = $dt.Columns.Add("DisplayName")
            $null = $dt.Columns.Add("SamAccountName")
            $null = $dt.Columns.Add("mail")
            $null = $dt.Columns.Add("Department")
            $null = $dt.Columns.Add("Title")
...
$btnImportFile.Add_Click({
        ...
        if ($openFile.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) {
            ...
            foreach ($line in $lines) { $null = $dgvInput.Rows.Add($line.Trim()) }
            Update-Status "Imported $($lines.Count) identifier(s) from file."
        }
    })

# Bulk Process (v2.0: validation, confirm dialog, wait cursor, success/error counts)
$ProcessGrid = {
    param($Action)
    ...
    foreach ($row in $dgvInput.Rows) {
        if ($row.Cells["colIdentifier"].Value) {
            $userList.Add($row.Cells["colIdentifier"].Value.ToString().Trim())
        }
    }

    $users = $userList | Select-Object -Unique

    if ([string]::IsNullOrWhiteSpace($groupName) -or $users.Count -eq 0) {
        [System.Windows.Forms.MessageBox]::Show("Please provide both Target Group and User identifiers.", "Validation Error", "OK", "Warning")
        return
    }
    ...
    if ([System.Windows.Forms.MessageBox]::Show($confirmMsg, "Confirm Bulk $Action", "YesNo", "Question") -eq "No") {
        Update-Status "Bulk $Action cancelled."
        return
    }

    $saveLog = New-Object System.Windows.Forms.SaveFileDialog
    $saveLog.Filter = "Text Files (*.txt)|*.txt"
    $saveLog.FileName = "BulkUpdate_Log_$(Get-Date -Format 'yyyyMMdd').txt"
        ...
        try {
            ...
            foreach ($u in $users) {
                try {
                    ...
                    $s = "[ERROR] $u : $($_.Exception.Message)"
                    $errorCount++
                }

                $txtUpdateLog.AppendText("`r`n$s")
                $s | Out-File $logPath -Append
...
$btnClearTab1.Add_Click({
        $txtGroupSearch.Text = ""
        $dgvMembers.DataSource = $null
        $dgvSubGroups.DataSource = $null
        $lblCount.Text = "Sub-Groups: 0 | Total Members: 0"
        $btnExport.Enabled = $false
        Update-Status "Audit tab cleared."
    })

$btnClearTab2.Add_Click({
        $txtTargetGroup.Text = ""
        $dgvInput.Rows.Clear()
        $txtUpdateLog.Clear()
        Update-Status "Bulk Updates tab cleared."
    })

# Tab "Access Checker" Logic
$btnCheckAccess.Add_Click({
        ...
        try {
            ...
            $null = $dt.Columns.Add("FileSystemRights")
            $null = $dt.Columns.Add("AccessControlType")
            $null = $dt.Columns.Add("IsInherited")
            $null = $dt.Columns.Add("AccessType")
            ...
            $null = $dtGroups.Columns.Add("ACL Group")
            $null = $dtGroups.Columns.Add("Membership")
                    ...
                    try {
                        ...
                        if ($userSam -notin $directSams) {
                            ...
                            foreach ($sg in $subGroups) {
                                $sgMembers = Get-ADGroupMember -Identity $sg -Recursive -ErrorAction SilentlyContinue |
                                    Select-Object -ExpandProperty SamAccountName
...
$btnClearTab4.Add_Click({
        $txtAccessPath.Text = ""
        $txtAccessUser.Text = ""
        $dgvAccess.DataSource = $null
        $dgvMatchedGroups.DataSource = $null
        $lblAccessInfo.Text = ""
        Update-Status "Access Checker tab cleared."
    })

# ✅（可選但建議）首次顯示後再做一次最終校正（避免 DPI/字體延遲）
$form.Add_Shown({
    try {
        Set-TextboxWidthToLeaveRoom -TextBox $txtGroupSearch -RightControls @($btnFetch, $btnExport, $btnClearTab1)
        Set-TextboxWidthToLeaveRoom -TextBox $txtTargetGroup -RightControls @($btnImportFile)
