...
# 2026-02-25 v2.3 17:38PM
# @Albert Ng
# AD Security Group Manager - Version 2.3
# =================================================================================
...
# 3. UI Interface Code (Version 2.0 - Improved Edition)

# =================================================================================

$form = New-Object System.Windows.Forms.Form

$form.Text = "AD Security Group Manager - Version 2.2"
...
$txtAccessPath.Location = "20, 155"; $txtAccessPath.Size = "680, 25"

$tabAccessChk.Controls.Add($txtAccessPath)

  

$btnBrowseAccessPath = New-Object System.Windows.Forms.Button

$btnBrowseAccessPath.Location = "710, 153"; $btnBrowseAccessPath.Size = "100, 28"; $btnBrowseAccessPath.Text = "Browse..."

$btnBrowseAccessPath.Add_Click({

    $browser = New-Object System.Windows.Forms.FolderBrowserDialog

    if ($browser.ShowDialog() -eq [System.Windows.Forms.DialogResult]::OK) { $txtAccessPath.Text = $browser.SelectedPath }

})

$tabAccessChk.Controls.Add($btnBrowseAccessPath)
