...
function InitialDataColect
{
    ...
    foreach($DG in $DefaultGroups)
    {
        $global:CorporateDefaultGroup +=$DG
    }
}
InitialDataColect
...
$PowerShellForms.Size = New-Object System.Drawing.Size(640,530)
...
$Page1_TBJoinerSamAccountName.Add_LostFocus(
    {
        #[System.Windows.Forms.Messagebox]::Show("LostFocus")
        if($Page1_RBFinalizeADAccount.Checked -eq $True)
        {
            if($Page1_TBJoinerSamAccountName.Text -ne "")
            {
                ...
                try {
                    ...
                    $Page1_TBJoinerEA11.Text = $userInfo.extensionAttribute11
...
$Page1_LbJoinerEmployeeID.Text = "EmployeeID\/EA1"
...
$Page1_LbJoinerEmployeeID.Location = New-Object System.Drawing.Point(300,160)
$Page1_LbJoinerEmployeeID.Tag="EmployeeID/EA1"
...
$Page1_TBJoinerEmployeeID.Location = New-Object System.Drawing.Point(420,160)
...
$Page1_DepartmentList.Add_SelectedIndexChanged(
    {
        ...
        if($CorporateDefaultGroup[0] -ne "")
        {
            foreach($CDG in $CorporateDefaultGroup)
            {
                $Page1_DefaultGroupList.Items.Add($CDG)
            }
        }
        ...
        for($site=0;$site -le $xmldata.Sites.ChildNodes.Count-1;$site++)
        {
            if($xmldata.Sites.ChildNodes[$site].Code -eq $Page1_OfficeList.SelectedItem)
            {
                ...
                if($TG -ne "")
                {
                    ...
                    foreach($SDG in $SiteDefaultGroups)
                    {
                        $Page1_DefaultGroupList.Items.Add($SDG)
                    }
                }
                ...
                foreach($Department in $xmldata.Sites.ChildNodes[$site].ChildNodes)
                {
                    if($Department.Name -eq $Page1_DepartmentList.SelectedItem)
                    {
                        ...
                        foreach($TDG in $TeamDefaultGroups)
                        {
                            $Page1_DefaultGroupList.Items.Add($TDG)
                        }
                        #Add logon script
...
$Page1_LbJoinerEA9.Location = New-Object System.Drawing.Point(10,190)
...
$Page1_TBJoinerEA9.Location = New-Object System.Drawing.Point(105,190)
...
$Page1_LbJoinerEA11.Location = New-Object System.Drawing.Point(300,190)
...
$Page1_TBJoinerEA11.Location = New-Object System.Drawing.Point(420,190)
...
$Page1_LbJoinerLogonScript.Location = New-Object System.Drawing.Point(10,220)
...
$Page1_TBJoinerLogonScript.Location = New-Object System.Drawing.Point(105,220)
...
$Page1_LbJoinerEmployeeType.Location = New-Object System.Drawing.Point(300,220)
...
$Page1_TBJoinerEmployeeType.Location = New-Object System.Drawing.Point(420,220)
...
$Page1_LbJoinerOU.Location = New-Object System.Drawing.Point(10,250)
...
$Page1_TBJoinerOU.Location = New-Object System.Drawing.Point(105,250)
...
$Page1_LbDefaultGroups.Location = New-Object System.Drawing.Point(10,280)
...
$Page1_DefaultGroupList.Location = New-Object System.Drawing.Point(105,280)
...
$Page1_BtnAddGroup.Location = New-Object System.Drawing.Point(540,370)
...
$Page1_BtnAddGroup.Add_Click(
    {
        if($Page1_TBNewGroup.Text.Length -gt 0)
        {
            $Page1_DefaultGroupList.Items.Add($Page1_TBNewGroup.Text)
...
$Page1_TBNewGroup.Location = New-Object System.Drawing.Point(105,370)
...
$Page1_BtnRemoveGroup.Location = New-Object System.Drawing.Point(575,370)
...
$Page1_LbInitialPassword.Location = New-Object System.Drawing.Point(10,415)
...
$Page1_TBInitialPassword.Location = New-Object System.Drawing.Point(105,415)
...
$Page1_BtnGeneratePassword.Location = New-Object System.Drawing.Point(300,415)
...
$Page1_BtnGo.Location = New-Object System.Drawing.Point(510,415)
$Page1_BtnGo.Text = "Go"
...
$Page1_BtnGo.Add_Click(
    {
            ...
            if($inputvalid -eq $true)
            {
                ...
                if($usercount -eq 0) #cannot find target samaccount in AD
                {
                    ...
                    if(($Result -eq "OK") -or ($EmailConflict -eq $false))
                    {
                        ...
                        try {
                            New-ADUser -Name $Page1_TBJoinerFullName.Text -Description $Page1_TBJoinerTicket.Text -DisplayName $Page1_TBJoinerDisplayName.Text -GivenName $Page1_TBJoinerFirstName.Text -Department $Page1_DepartmentList.SelectedItem -ScriptPath $Page1_TBJoinerLogonScript.Text -SamAccountName $Page1_TBJoinerSamAccountName.Text -EmailAddress $Page1_TBEmail.Text -Surname $Page1_TBJoinerLastName.Text -Path $Page1_TBJoinerOU.Text -Enabled $true -AccountPassword $Secure_Pwd -OtherAttributes $EAs

                            try {
                                foreach($ADGroup in $Page1_DefaultGroupList.Items)
                                {
                                    get-aduser -Filter {samaccountname -eq $Page1_TBJoinerSamAccountName.Text } | %{Add-ADGroupMember -Identity $ADGroup -Members $_.samaccountname} -ErrorAction Continue
                                }
                            }
                            catch {
        ...
        elseif($Page1_RBFinalizeADAccount.Checked -eq $true) #Finalize ad account
        {
            ...
            if($inputvalid -eq $true)
            {
                ...
                $Result_GroupMember = "Success"
                try {
                    get-aduser -Filter {samaccountname -eq $Page1_TBJoinerSamAccountName.Text } | set-aduser -DisplayName $Page1_TBJoinerDisplayName.Text -ScriptPath $Page1_TBJoinerLogonScript.Text -Department $Page1_DepartmentList.SelectedItem -Replace $EAs
