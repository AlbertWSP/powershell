...
# Display the groups that have permissions
$groups = $acl.Access | Where-Object { $_.IdentityReference -match 'Group' } | ForEach-Object {
    [PSCustomObject]@{
...
# Check and display the members of each group
$groups | ForEach-Object {
    $groupName = $_.Value
    Write-Host "Members of group $groupName"
    Get-ADGroupMember -Identity $groupName | Select-Object Name, ObjectClass | Format-Table -AutoSize
}