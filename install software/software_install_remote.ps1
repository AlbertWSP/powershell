...
$setupFilePath1 = "\\corp.pbwan.net\hk\Transition\DAT18\kits\Software\Engineering\ETABS\ETABSv2210Setup.exe"
$setupFilePath2 = "\\corp.pbwan.net\hk\Transition\DAT18\kits\Software\Engineering\SAFE\SAFEv2210Setup.exe"
$setupFilePath3 = "\\corp.pbwan.net\hk\Transition\DAT18\kits\Software\Engineering\SAP2000\SAP2000v2510Setup.exe"
$setupFilePath4 = "\\corp.pbwan.net\hk\Transition\DAT18\kits\Software\Engineering\7zip\7z2409-x64.msi"
...
$destinationPath4 = "\\$hostName\C$\temp\7z2409-x64.msi"
...
if ($option4Enabled) {
    Perform-Setup -hostName $hostName -setupFilePath $setupFilePath4 -destinationPath $destinationPath4 -setpath "C:\temp\7z2409-x64.msi" -commandLine '/q'
}
