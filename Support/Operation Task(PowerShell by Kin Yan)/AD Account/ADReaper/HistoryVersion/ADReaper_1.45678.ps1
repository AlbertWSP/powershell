...
$PowerShellForms.Size = New-Object System.Drawing.Size(470,590)
...
$tabPageGetPCList=New-Object System.Windows.Forms.TabPage
$tabPageGetPCList.text = "AD Object"
$tabPageGetPCList.TabIndex=0
...
$tabPageGetPCList.Controls.AddRange($Page1_tbCustomizeOUPath)
...
$tabPageGetPCList.Controls.AddRange($Page1_CbCustomizeOU)
...
$tabPageGetPCList.Controls.AddRange($Page1_GBObjectType)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbAsia)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbCN)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbHK)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbSG)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbTW)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbTH)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbKR)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbMY)
...
#$tabPageGetPCList.Controls.AddRange($Page1_CbPH)
...
$Page1_BtnSelectCSVFile.Location = New-Object System.Drawing.Size(230,170)
...
$tabPageGetPCList.Controls.AddRange($Page1_lbADProperty)
...
$tabPageGetPCList.Controls.AddRange($Page1_tbADProperty)
...
$lbReportPath.Location = New-Object System.Drawing.Point(15,455)
...
$tbReportPath.Location = New-Object System.Drawing.Point(120,455)
...
$BtnGenerateReport.Location = New-Object System.Drawing.Size(290,490)
...
function GenerateList
{
    ...
    #$ReportColumn=$Page1_tbADProperty.Text.Split(',')
    ...
    elseif($Page1_RBUser.Checked -eq $true) #User
    {
        if($Page1_CbImportFromCSV.Checked -eq $true)
        {
            ...
            ForEach($UserList in $List){
                ...
                #Get-ADUser -filter {EmailAddress -eq $UserList} -Properties $ReportColumn | select $ReportColumn | export-csv -encoding UTF8 -NoTypeInformation -Force -Append -Path $filename
                Invoke-Expression -Command $cmdline
                }
        }
        else {
...
$TabControl1.Controls.Add($tabPageGetPCList)
