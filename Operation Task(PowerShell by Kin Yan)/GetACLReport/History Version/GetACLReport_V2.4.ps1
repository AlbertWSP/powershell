...
#What's new in V2.4(2023/6/15)
#1. Update ACL folder path
#2. 

#What's new in V2.3(2023/2/8)
#1. Fix the incorrect path issue

#What's new in V2.2(2023/1/17)
#1. Code clean up
#2. Modify get acl report logic
#2. Scan folder last updated:20220713
...
$PowerShellForms.Size = New-Object System.Drawing.Size(500,510)
